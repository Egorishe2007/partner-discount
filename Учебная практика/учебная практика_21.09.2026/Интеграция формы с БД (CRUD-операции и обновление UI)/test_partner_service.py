...
class TestPartnerService(unittest.TestCase):
    ...
    def test_card_fields_come_from_query(self):
        partner = get_partner_with_discount(FakeConnection([make_row(0)]), 1)
        self.assertEqual(partner["legal_address"],
                         "г. Москва, ул. Строителей, д. 1")
        self.assertEqual(partner["inn"], "7700000001")
